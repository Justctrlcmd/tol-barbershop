  ...
  return (
    <>
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Public bookings:</strong> name, verified email address, phone
            number, barber, service, date, time, notes, group-member names, price,
            status, and booking reference.
          </li>
          <li>
            <strong>Email records:</strong> one-time verification data and delivery
            status for booking updates. Verification codes are stored as secure
            hashes and expire.
          </li>
          <li>
            <strong>Bookings:</strong> confirmation, rejection, rescheduling,
            cancellation, completion, no-show, and related reasons or timestamps.
          </li>
          <li>
            <strong>Feedback:</strong> rating, optional comment, booking
            relationship, and whether staff feature the review publicly.
          </li>
          <li>
            <strong>Walk-ins, assisted bookings, and staff accounts:</strong>{" "}
            operational customer details entered by staff and the identity, contact,
            role, session, and security data required for authorized staff access.
          </li>
          <li>
            <strong>Remembered booking details:</strong> after a successful email
            verification, your name, email address, and phone number are saved in
            your current browser for up to 90 days.
          </li>
          <li>
            <strong>Technical data:</strong> security cookies, request metadata,
            rate-limit records, and application logs.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          website&apos;s browser data. We use input validation, sanitization, rate
          limits, hashed verification codes, role-restricted staff access, and
          security headers. No system can guarantee absolute security.
        </p>
      </section>
